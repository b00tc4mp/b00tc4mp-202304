...
document.querySelector('.login-page').querySelector('form').onsubmit = function (event) {
    ...
    if (!authenticated)
        ...
        document.querySelector('.home-page').querySelector('.home-header').querySelector('.home-title').innerText = 'Hello, ' + user.name + '!'
    ...
    for (let i = 0; i < posts.length; i++) {
        ...
        if (post.user === context.email || (post.user !== context.email && post.visibility === 'public')) {
            ...
            if (post.user === context.email) {
                ...
                sellButton.onclick = () => {
                    document.querySelector('.home-page').querySelector('.sell-post-modal').querySelector('input[name=postId]').value = post.id
                    document.querySelector('.home-page').querySelector('.sell-post-modal').querySelector('input[name=price]').value = post.price

                    document.querySelector('.home-page').querySelector('.sell-post-modal').classList.remove('off')
                }
                ...
                buyButton.onclick = () => {
                    document.querySelector('.home-page').querySelector('.buy-post-modal').querySelector('input[name=postId]').value = post.id
                    document.querySelector('.home-page').querySelector('.buy-post-modal').querySelector('span').innerText = post.price

                    document.querySelector('.home-page').querySelector('.buy-post-modal').classList.remove('off')
                }
...
function renderMinePosts() {
    document.querySelector('.home-page').querySelector('.mine-posts').innerHTML = ''
    ...
    for (let i = 0; i < posts.length; i++) {
        ...
        if (post.user === context.email) {
            ...
            document.querySelector('.home-page').querySelector('.mine-posts').append(article)
        }
    }
}
...
document.querySelector('.home-page').querySelector('.home-header').querySelector('.favs-link').onclick = event => {
    ...
    document.querySelector('.home-page').querySelector('.mine-posts').classList.add('off')
    document.querySelector('.home-page').querySelector('.fav-posts').classList.remove('off')

    renderFavPosts()
}

document.querySelector('.home-page').querySelector('.home-header').querySelector('.mine-link').onclick = event => {
    event.preventDefault()

    document.querySelector('.home-page').querySelector('.posts').classList.add('off')
    document.querySelector('.home-page').querySelector('.fav-posts').classList.add('off')
    document.querySelector('.home-page').querySelector('.mine-posts').classList.remove('off')

    renderMinePosts()
}

document.querySelector('.home-page').querySelector('.home-header').querySelector('.home-title').onclick = () => {
    document.querySelector('.home-page').querySelector('.fav-posts').classList.add('off')
    document.querySelector('.home-page').querySelector('.mine-posts').classList.add('off')
    document.querySelector('.home-page').querySelector('.posts').classList.remove('off')
...
document.querySelector('.home-page').querySelector('.sell-post-modal').querySelector('.cancel-button').onclick = function (event) {
    event.preventDefault()

    document.querySelector('.home-page').querySelector('.sell-post-modal').classList.add('off')
}

document.querySelector('.home-page').querySelector('.sell-post-modal').querySelector('.post-form').onsubmit = function (event) {
    event.preventDefault()
...
document.querySelector('.home-page').querySelector('.buy-post-modal').querySelector('.cancel-button').onclick = function (event) {
    event.preventDefault()

    document.querySelector('.home-page').querySelector('.buy-post-modal').classList.add('off')
}

document.querySelector('.home-page').querySelector('.buy-post-modal').querySelector('.post-form').onsubmit = function (event) {
    event.preventDefault()
